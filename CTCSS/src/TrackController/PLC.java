...
/**
 * Checks the status of the blocks associated with the given Track Controller and acts accordingly.
 * @author Zachary Shelhamer
 *
 */
public class PLC {
	 ...
	 * @param tcm Instance of Track Controller Module
	 * @param sim Instance of Simulator
	 * @param currentPanel Instance of Track Controller Panel
	 */
	 ...
	 * @param blockNumber Number of broken block
	 */
